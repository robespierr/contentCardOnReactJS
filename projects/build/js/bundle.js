...
module.exports = React.createClass({displayName: "exports",
    ...
    render: function() {
        return (
            React.createElement("article", {className: "card", style:  {backgroundImage: 'url('+ this.props.backgroundImage +')'} }, 
                ...
                React.createElement("div", {className: "card__controls"}, 
                    ...
                    React.createElement("div", {className: "card__controls-item"}, 
                        React.createElement("button", {className: "card__button", onClick: this.handleCardPrint}, 
                            React.createElement("i", {className: "fa fa-print"})
                        )
                    ), 
                    React.createElement("div", {className: "card__controls-item"}, 
                        React.createElement("button", {className: "card__button", onClick: this.handleCardShare}, 
...
module.exports = React.createClass({displayName: "exports",
    render: function() {
        var cardsItems = this.props.data.map(function(card) {
            return (
                React.createElement("div", {className: "cards-list__item grid__item one-quarter lap--one-half palm--one-whole", key: card.id}, 
                    React.createElement(Card, {link: card.link, 
                          icon: card.icon, 
                          title: card.title, 
